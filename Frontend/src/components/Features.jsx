    ...
    <section id="features" className="bg-[#00334D] relative pt-10 pb-5">
      ...
      <div className="space-y-7 px-2 md:px-0">
        {features.map((feature, index) => (
          <div
            key={index}
            className={`flex flex-col lg:flex-row items-center my-9 ${
          ...
          >
            ...
            <div className="lg:w-1/2 p-2 flex justify-center lg:justify-start">
              <img
                ...
                className={`transition-transform duration-300 transform hover:scale-105 ${
                  index === 1
                    ? "mt-[-20px] lg:mt-[-120px] lg:ml-[95px]"
                    : "mt-[-20px] lg:mt-[-86px] lg:ml-[155px]"
                }`}
            ...
            {/* Text Section */}
            <div
              className={`lg:w-1/2 p-2 text-center lg:text-left ${
                index === 1
                  ? "mt-0 lg:mt-[-60px] lg:ml-[90px]"
                  : "mt-0 lg:mt-[-75px] lg:mr-[150px]"
              }`}
            >
              <div className="bg-white p-4 rounded-lg shadow-lg transition-transform duration-300 transform hover:scale-105">
                <h3 className="text-lg text-center lg:text-[26px] font-bold text-[#00334D] mb-3">
                  {feature.title}
                </h3>
                <p className="text-[15px] lg:text-[15.5px] font-medium text-[#00334D]">
                  {feature.description}
                </p>
              </div>
            </div>
