  ...
  return (
    <div className="bg-[#F2F2F2] py-3md:py-10 flex flex-col md:flex-row items-center justify-center"> {/* Adjusted padding */}
      <div className="mx-auto max-w-6xl md:text-left md:w-1/2 px-4 md:px-0">
        <h2 className="text-xl md:text-3xl lg:text-[38px] font-bold text-[#00334D] sm:text-4xl animate-fadeIn mt-[-10px] leading-snug ml-7">
          Transform Your Study Experience with StudySphere!
        </h2>

        <p className="mt-3 text-[18px] md:text-[20px] text-gray-900 animate-fadeIn ml-7">
        ...
        <div className="mt-5 flex flex-col md:flex-row justify-center md:justify-start gap-2 ml-36">
          <a
            href="#"
